...
public class Adactin_hotel_booking_task {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		book_now.click();
		WebElement Booked_Itinerary = driver.findElement(By.linkText("Booked Itinerary"));
		Booked_Itinerary.click();
		WebElement select_all_checkbox = driver.findElement(By.xpath("//input[@name='check_all']"));
